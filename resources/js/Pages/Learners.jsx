        ...
        >
            ...
            <div className="p-8">
                ...
                <div className='grid grid-cols-4 gap-4'>
                    <div className="px-4 py-6 info-card box-shadow: 0 1px 3px 0 rgba(0,0,0,0.1), 0 1px 2px -1px rgba(0,0,0,0.1);">
                        <div className='py-2'>
                            <span className='font-light'>Total Learners</span>
                        </div>
                        <div className='py-2'>
                            <span className='font-semibold text-lg text-cyan-600'>1,000</span>
                        </div>
                    </div>
                    <div class="px-4 py-6 info-card box-shadow: 0 1px 3px 0 rgba(0,0,0,0.1), 0 1px 2px -1px rgba(0,0,0,0.1); ">
                        <div className='py-2'>
                            <span className='font-light'>Total Males</span>
                        </div>
                        <div className='py-2'>
                            <span className='font-semibold text-lg text-cyan-600'>700</span>
                        </div>
                    </div>
                    <div class="px-4 py-6 info-card box-shadow: 0 1px 3px 0 rgba(0,0,0,0.1), 0 1px 2px -1px rgba(0,0,0,0.1);">
                        <div className='py-2'>
                        ...
                        <div className='py-2'>
                            <span className='font-semibold text-lg text-cyan-600'>800</span>
                        </div>
                    </div>
